...
import com.oj.cs.model.dto.post.PostAddRequest;
import com.oj.cs.model.dto.post.PostEditRequest;
import com.oj.cs.model.dto.post.PostQueryRequest;
import com.oj.cs.model.dto.post.PostUpdateRequest;
import com.oj.cs.model.entity.Post;
import com.oj.cs.model.entity.User;
import com.oj.cs.model.vo.PostVO;
...
public class PostController {
  ...
  public BaseResponse<PostVO> getPostVOById(long id, HttpServletRequest request) {
    ...
    // 添加调试日志
    log.info("正在查询帖子ID: {}", id);
    Post post = postService.getById(id);
    log.info("查询结果: {}", post != null ? "找到帖子" : "未找到帖子");
    if (post != null) {
      log.info(
          "帖子详情: id={}, title={}, isDelete={}", post.getId(), post.getTitle(), post.getIsDelete());
    }
    if (post == null) {
  ...
  public BaseResponse<Page<PostVO>> listPostVOByPage(
    ...
    Page<Post> postPage =
        postService.page(new Page<>(current, size), postService.getQueryWrapper(postQueryRequest));
