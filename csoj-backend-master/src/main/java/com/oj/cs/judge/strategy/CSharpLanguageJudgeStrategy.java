...
@Slf4j
@Component
public class CSharpLanguageJudgeStrategy implements JudgeStrategy {
  ...
  public JudgeInfo doJudge(JudgeContext judgeContext) {
    ...
    // C# (.NET) 运行时启动时间约 2-3 秒
    long CSHARP_RUNTIME_TIME_COST = 2500L;
    if ((time - CSHARP_RUNTIME_TIME_COST) > needTimeLimit) {
