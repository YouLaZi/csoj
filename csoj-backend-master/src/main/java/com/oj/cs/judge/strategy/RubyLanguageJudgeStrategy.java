...
@Slf4j
@Component
public class RubyLanguageJudgeStrategy implements JudgeStrategy {
  ...
  public JudgeInfo doJudge(JudgeContext judgeContext) {
    ...
    // Ruby 解释器启动时间约 1-2 秒
    long RUBY_INTERPRETER_TIME_COST = 1500L;
    if ((time - RUBY_INTERPRETER_TIME_COST) > needTimeLimit) {
